      ...
      <View className="flex-row items-center justify-between px-4 py-3 border-b border-gray-100">
        <View>
            <Text className="text-xl font-bold text-gray-900">
              {currentUser?.firstName || 'Loading...'} {currentUser?.lastName || ''}
            </Text>
            <Text className="text-gray-500 text-sm">{Array.isArray(userPosts) ? userPosts.length : 0} Posts</Text>
        </View>
        <SignOutButton />
      </View>
        ...
        <View className="px-4 pb-4 border-b border-gray-100">
          ...
          <View className="flex-row items-center mb-3">
            ...
            <Text className="text-gray-500 ml-2">
              Joined {currentUser?.createdAt ? format(new Date(currentUser.createdAt), "MMMM yyyy") : ''}
            </Text>
          </View>
